            ...
            {projects.map((project, index) => {
              const Card = (
                <motion.div
                  ...
                  className="group gradient-card rounded-xl overflow-hidden border border-border hover:border-primary transition-all duration-300 hover:glow-primary cursor-pointer"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                >
                  ...
                  <p className="text-foreground mb-2">31st July - 2nd Aug 2025</p>
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <p className="text-foreground mb-1">Dec 5, 2025</p>
                  ...
                  <div className="p-4 rounded-lg bg-background/50 border border-border">
                    ...
                    <p className="text-foreground mb-1">January, 2026</p>
                    <p className="text-muted-foreground text-sm">IIITD</p>
                  </div>
                </div>
              </motion.div>
            </div>
